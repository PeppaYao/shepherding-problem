...
import time
import math
from AAAAstrategy import shepherdR
from AAAAstrategy import sheepR
from AAAAstrategy import behaviors as cb
...
if __name__ == '__main__':
    ...
    steps = []
    n = 50
    for dist in range(100, 150, 10):
        all_sheep, sheep_dict, shepherd_a = init_sheep(canvas, n)
        step = run_animation(all_sheep, sheep_dict, shepherd_a, dist)
        print("current {}, dispersion {}:".format(dist, step))
        steps.append(step)
