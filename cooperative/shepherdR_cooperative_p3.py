...
def collecting(herd_a, herd_b, all_sheep, speed, app_dist, left, right, target):
    ...
    far_a = common.find_directed_max_angle_sheep(herd_point_b, g_mean_b, all_sheep, target)
    gt_dist_a = la.norm(far_a - g_mean_a)

    far_b = common.find_directed_max_angle_sheep(herd_point_b, g_mean_b, all_sheep, target)
