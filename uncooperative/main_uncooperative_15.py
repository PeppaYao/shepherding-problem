...
import time
import math
from uncooperative import shepherdR_uncooperative_15 as R15
...
def run_animation(all_sheep, sheep_dict, herd_a, herd_b):
    ...
    while True:
        ...
        if common.check(all_sheep, radius):
            R15.driving(herd_a, herd_b, all_sheep, speed, target, app_dist)
        else:
            R15.collecting(herd_a, herd_b, all_sheep, speed, app_dist, target)
