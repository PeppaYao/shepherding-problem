...
import time
import math
from uncooperative import shepherdR_uncooperative_a as Ra
...
def run_animation(all_sheep, sheep_dict, herd_a, herd_b):
    ...
    while True:
        ...
        if common.check(all_sheep, radius):
            Ra.driving(herd_a, herd_b, all_sheep, speed, target, app_dist)
        else:
            Ra.collecting(herd_a, herd_b, all_sheep, speed, app_dist, target)
