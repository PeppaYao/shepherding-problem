...
def collecting(herd_a, herd_b, all_sheep, speed, app_dist):
    ...
    far_a = common.find_r_max_angle_sheep(herd_point_a, g_mean, all_sheep, 'clockwise')
    gt_dist_a = la.norm(far_a - g_mean)

    far_b = common.find_r_max_angle_sheep(herd_point_b, g_mean, all_sheep, 'anticlockwise')
