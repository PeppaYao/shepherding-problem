...
import time
import math
from uncooperative import shepherdR_uncooperative_11 as R4
...
def run_animation(all_sheep, sheep_dict, herd_a, herd_b):
    ...
    while True:
        ...
        if common.check(all_sheep, radius):
            R4.driving(herd_a, herd_b, all_sheep, speed, target, app_dist)
        else:
            R4.collecting(herd_a, herd_b, all_sheep, speed, app_dist)
