...
import time
import math
from uncooperative import shepherdR_uncooperative_2 as R3
...
def run_animation(all_sheep, sheep_dict, herd_a, herd_b):
    ...
    while True:
        ...
        if common.check(all_sheep, radius):
            R3.driving(herd_a, herd_b, all_sheep, speed, target, app_dist)
        else:
            R3.collecting(herd_a, herd_b, all_sheep, speed, app_dist)
