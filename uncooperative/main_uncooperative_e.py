...
import time
import math
from uncooperative import shepherdR_uncooperative_e as Re
...
def run_animation(all_sheep, sheep_dict, herd_a, herd_b):
    ...
    while True:
        ...
        if common.check(all_sheep, radius):
            Re.driving(herd_a, herd_b, all_sheep, speed, target, app_dist)
        else:
            Re.collecting(herd_a, herd_b, all_sheep, speed, app_dist, target)
